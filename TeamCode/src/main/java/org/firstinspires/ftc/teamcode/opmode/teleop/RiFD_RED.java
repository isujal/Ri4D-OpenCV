...
@Config
@TeleOp(name = "RiFD RED \uD83D\uDE21 ", group = "00000")
//@TeleOp(name = "Pagal Bot 4 Blue \uD83E\uDD76 ", group = "00000")
public class RiFD_RED extends CommandOpMode {
    ...
    /// RED Teleop
    shootersubsystem.TURRET_STATES humanPlayerTurret  = shootersubsystem.TURRET_STATES.FAR_RED_TELE_HUMANP; // for red
    public static double ImuOff = 0; // for blue
    /// BLUE Teleop
...
//        pidf = new PIDFController(flykP, flykI, flykD, flykF);
        pidf.setPIDF(flykP, flykI, flykD, flykF);
