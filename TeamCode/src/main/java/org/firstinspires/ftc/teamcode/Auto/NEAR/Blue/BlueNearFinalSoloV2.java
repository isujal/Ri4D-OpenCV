...
//
//
////TODO 24 Artifact auto, 2 to 3 sec requited for last spikeMark Shooting
//@Autonomous(name = "BLUE Near Solo️V2 24 Artifact ", group = "BLUE NEAR")
//public class BlueNearFinalSoloV2 extends LinearOpMode {
//
...
//
////                //TODO ====================== GatePick 1 =========================
////                new KPathCommand2(follower, nearPath.GateIntake2, 0.85,"holdBlueStraight" ).alongWith(
////                        new ParallelCommandGroup(
...
////
////                new WaitCommand(500),
////                new KPathCommand2(follower, nearPath.GateIntake21).alongWith(
////                        new SequentialCommandGroup(
...
//                        )
//                ),
//                new KPathCommand2(follower, nearPath.GateIntake1)
////                new KPathCommand2(follower, nearPath.GateIntake1)
//                        .alongWith(
//                        new ParallelCommandGroup(
//                                intakeBackAutoGate(intakess, shooterss, gatess),
