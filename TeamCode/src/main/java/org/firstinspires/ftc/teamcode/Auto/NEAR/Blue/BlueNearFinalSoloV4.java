...
//
////TODO 1st and 3rd SPIKE at the end
////TODO Woking Code
//@Autonomous(name = "BLUE Near SOLO Final", group = "BLUE NEAR")
//public class BlueNearFinalSoloV4 extends LinearOpMode {
//
...
//                        new ParallelCommandGroup(
//                                intakeBackAutoGate(intakess, shooterss, gatess),
//                                new WaitForSensorCommand(() -> (!robot.FfeederBeam.getState() || !robot.FintakeBeam.getState()), backTimer - 500, 25).andThen(
//                                        intakess.IntakeFCommands(intakesubsystem.INTAKEF.OFF)
//                                ),
//                                new WaitForSensorCommand(() -> ((!robot.FfeederBeam.getState() || !robot.FintakeBeam.getState()) && !robot.midBeam.getState() && (!robot.BfeederBeam.getState() || !robot.BintakeBeam.getState())), frontTimer - 500, 25).andThen(
//                                        new ParallelCommandGroup(
//                                                intakess.IntakeBCommands(intakesubsystem.INTAKEB.OFF),
//                                                intakess.IntakeFCommands(intakesubsystem.INTAKEF.OFF),
