...
//
//@Autonomous(name = "BLUE Far Final ", group = "BLUE")
...
//                        new ParallelCommandGroup(
//                                intakeBackAuto(intakess, shooterss),
//                                new WaitForSensorCommand(() -> (!robot.FfeederBeam.getState() || !robot.FintakeBeam.getState()), 400, 50).andThen(
//                                        intakess.IntakeFCommands(intakesubsystem.INTAKEF.OFF)
//                                )
//                        )
//                ),
...
////                new KPathCommand3(follower, farPath.RANDOM32, 3.5).alongWith(
////                        new WaitForSensorCommand(() -> (!robot.BfeederBeam.getState() || !robot.BintakeBeam.getState()), 2000, 50).andThen(
////                                intakess.IntakeBCommands(intakesubsystem.INTAKEB.OFF)
////                        )
////                ),
//
//                new KPathCommand3(follower, farPath.RANDOM4, 3.5)
//                        .alongWith(
//                                new ParallelCommandGroup(
//                                        intakeBackAuto(intakess, shooterss),
...
//                ,
//                ///TODO ==================== Random Shoot 1 ====================
//                new KPathCommand3(follower, farPath.RSHOOT4).alongWith(
//                        new ParallelCommandGroup(
//                                farShootingAUTO(shooterss),
//                                new WaitForSensorCommand(() -> (!robot.BfeederBeam.getState() || !robot.BintakeBeam.getState()), 500, 50).andThen(
//                                        new ParallelCommandGroup(
