...
//
//@Autonomous(name = "RED Far Final ", group = "RED 🔴")
...
////                ),
//
//                new KPathCommand3(follower, farPath.Random_StraightCorner, 3.5)
//                        .alongWith(
//                                new ParallelCommandGroup(
//                                        intakeFrontAuto(intakess, shooterss),
//                                        new WaitForSensorCommand(() -> (!robot.BfeederBeam.getState() || !robot.BintakeBeam.getState()), 2000, 50).andThen(
...
//                ,
//                ///TODO ==================== Random Shoot 1 ====================
//                new KPathCommand3(follower, farPath.Random_StraightCorner_toshoot).alongWith(
//                        new ParallelCommandGroup(
//                                farShootingAUTO(shooterss),
//                                new WaitForSensorCommand(() -> (!robot.FfeederBeam.getState() || !robot.FintakeBeam.getState()), 500, 50).andThen(
//                                        new ParallelCommandGroup(
...
//
//                //TODO ==================== Random Pick 2 ====================
//                new KPathCommand3(follower, farPath.Random_StraightCorner_extra_push).alongWith(
//                        new ParallelCommandGroup(
//                                intakeFrontAuto(intakess, shooterss),
//                                new WaitForSensorCommand(() -> (!robot.BfeederBeam.getState() || !robot.BintakeBeam.getState()), 2000, 50).andThen(
//                                        intakess.IntakeBCommands(intakesubsystem.INTAKEB.OFF)
...
//                ),
//                ///TODO ==================== Random Shoot 2 ====================
//                new KPathCommand3(follower, farPath.Random_StraightCorner_extra_push_toshoot).alongWith(
//                        new ParallelCommandGroup(
//                                farShootingAUTO(shooterss),
//                                new WaitForSensorCommand(() -> (!robot.FfeederBeam.getState() || !robot.FintakeBeam.getState()), 500, 50).andThen(
//                                        new ParallelCommandGroup(
...
//
//                //TODO ====================  Random Pick 3 ====================
//                new KPathCommand3(follower, farPath.Random_near_spike).alongWith(
//                        new ParallelCommandGroup(
//                                intakeFrontAuto(intakess, shooterss),
//                                new WaitForSensorCommand(() -> (!robot.BfeederBeam.getState() || !robot.BintakeBeam.getState()), 2000, 50).andThen(
//                                        intakess.IntakeBCommands(intakesubsystem.INTAKEB.OFF)
...
//                ),
//                ///TODO ==================== Random Shoot 3 ====================
//                new KPathCommand3(follower, farPath.Random_near_spike_shoot).alongWith(
//                        new ParallelCommandGroup(
//                                farShootingAUTO(shooterss),
//                                new WaitForSensorCommand(() -> (!robot.FfeederBeam.getState() || !robot.FintakeBeam.getState()), 500, 50).andThen(
//                                        new ParallelCommandGroup(
