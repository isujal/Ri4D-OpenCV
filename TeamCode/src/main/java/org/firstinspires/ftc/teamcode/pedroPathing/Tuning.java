...
class LocalizationTest extends OpMode {
    ...
    public void init() {
        ...
        // blue far
        Pose startPose = new Pose(55.750, 6.880, Math.toRadians(0)); // 144 - 88.250

//        Pose startPose = new Pose(88.250, 6.880, Math.toRadians(0)); /// red far

//        Pose startPose = new Pose(88.250, 6.880, Math.toRadians(0));
...
class ForwardZeroPowerAccelerationTuner extends OpMode {
    ...
    public static double VELOCITY = Constants.velocityX;
...
class LateralZeroPowerAccelerationTuner extends OpMode {
    private final ArrayList<Double> accelerations = new ArrayList<>();
    public static double VELOCITY = Constants.velocityY;
    private double previousVelocity;
    private long previousTimeNano;
    private boolean stopping;
    private boolean end;
