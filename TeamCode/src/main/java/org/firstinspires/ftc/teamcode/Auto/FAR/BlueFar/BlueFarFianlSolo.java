//package org.firstinspires.ftc.teamcode.Auto.FAR.BlueFar;
//
...
//
//@Autonomous(name = "BLUE Far SOLO Final ", group = "BLUE")
//public class BlueFarFianlSolo extends LinearOpMode {
//
...
//                                shooterss.turretCommand(shootersubsystem.TURRET.BLUEAUTO),
...
//
//                //TODO ====================  Pick 4 ====================
//                new KPathCommand3(follower, farPath.SPIKE4).alongWith(intakeBackAuto(intakess, shooterss)),
//                new KPathCommand3(follower, farPath.SPIKE41, 3.5)
//                        .alongWith(
//                                new WaitForSensorCommand(() -> (!robot.FfeederBeam.getState() || !robot.FintakeBeam.getState()), 1000, 50).andThen(
...
//                                new WaitForSensorCommand(() -> (!robot.BfeederBeam.getState() || !robot.BintakeBeam.getState()), 500, 50).andThen(
//                                        new ParallelCommandGroup(
...
//                                new WaitForSensorCommand(() -> (!robot.FfeederBeam.getState() || !robot.FintakeBeam.getState()), 1800, 50).andThen(
//                                        intakess.IntakeFCommands(intakesubsystem.INTAKEF.OFF),
...
//                        new ParallelCommandGroup(
//                                intakeBackAuto(intakess, shooterss),
//                                new WaitForSensorCommand(() -> (!robot.FfeederBeam.getState() || !robot.FintakeBeam.getState()), 1300, 50).andThen(
//                                        intakess.IntakeFCommands(intakesubsystem.INTAKEF.OFF)
//                                )
//                        )
//                )
...
//
//                //TODO ====================  Random Pick 1 ====================
////                new KPathCommand3(follower, farPath.RANDOM3).alongWith(intakeBackAuto(intakess, shooterss)),
...
//                new KPathCommand3(follower, farPath.GATEINTAKE1, 0.6, "BLUE")
//                        .alongWith(
//                                new ParallelCommandGroup(
...
//                                                intakess.IntakeBCommands(intakesubsystem.INTAKEB.OFF)
//                                        ),
//                                        new WaitForSensorCommand(() -> ((!robot.FfeederBeam.getState() || !robot.FintakeBeam.getState()) && !robot.midBeam.getState() && (!robot.FfeederBeam.getState() || !robot.FintakeBeam.getState())), 3500, 25).andThen(
//                                                new ParallelCommandGroup(
//                                                        intakess.IntakeFCommands(intakesubsystem.INTAKEF.OFF),
//                                                        intakess.IntakeBCommands(intakesubsystem.INTAKEB.OFF),
