...
//
//@Autonomous(name = "RED Near Solo Final ", group = "RED NEAR")
//public class RedNearFinalSoloV2 extends LinearOpMode {
//
...
//                        ),
//
//                new WaitCommand(PreShootTimer),
//                back_feedAUTO(intakess),
//                new WaitCommand(ShootTimer + 50),
//
//                //TODO ====================== Pick 2 =========================
//                new KPathCommand2(follower, nearPath.SPIKE2).alongWith(
//                        new ParallelCommandGroup(
//                                intakeFrontAuto(intakess, shooterss),
//                                new WaitForSensorCommand(() -> (!robot.BfeederBeam.getState() || !robot.BintakeBeam.getState()), 1500, 50).andThen(
...
//                        new ParallelCommandGroup(
//                                nearShootingAuto(shooterss),
//                                new WaitForSensorCommand(() -> (!robot.FfeederBeam.getState() || !robot.FintakeBeam.getState()), 650, 50).
//                                        andThen(
//                                                new SequentialCommandGroup(
//                                                        new ParallelCommandGroup(
...
//                        )
//                ),
//                new KPathCommand2(follower, nearPath.GateIntake1,frontTimer + 500)
//                        .alongWith(
//                                new ParallelCommandGroup(
//                                        intakeFrontAutoGate(intakess, shooterss, gatess),
//                                        new WaitForSensorCommand(() -> (!robot.BfeederBeam.getState() || !robot.BintakeBeam.getState()), backTimer - 500, 25).andThen(
//                                                intakess.IntakeBCommands(intakesubsystem.INTAKEB.OFF)
//                                        ),
//                                        new WaitForSensorCommand(() -> ((!robot.BfeederBeam.getState() || !robot.BintakeBeam.getState()) && !robot.midBeam.getState() && (!robot.FfeederBeam.getState() || !robot.FintakeBeam.getState())), frontTimer - 500, 25).andThen(
//                                                intakess.IntakeBCommands(intakesubsystem.INTAKEB.OFF),
//                                                intakess.IntakeFCommands(intakesubsystem.INTAKEF.OFF),
...
//                        new ParallelCommandGroup(
//                                intakeFrontAuto(intakess, shooterss),
//                                new WaitForSensorCommand(() -> (!robot.BfeederBeam.getState() || !robot.BintakeBeam.getState()), 1600, 50).andThen(
//                                        intakess.IntakeBCommands(intakesubsystem.INTAKEB.OFF)
//                                )
//                        )
//                )
...
//                        new ParallelCommandGroup(
//                                nearShootingAuto(shooterss),
//                                new WaitForSensorCommand(() -> (!robot.FfeederBeam.getState() || !robot.FintakeBeam.getState()), 1000, 50).
//                                        andThen(
//                                                new SequentialCommandGroup(
//                                                        new WaitCommand(500),
//                                                        new ParallelCommandGroup(
