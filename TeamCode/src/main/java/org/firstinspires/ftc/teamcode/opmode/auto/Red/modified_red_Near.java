...
//@Disabled
@Autonomous(name = "red modified near", group = "RedAuto")
public class modified_red_Near extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.turret.setPosition(robot.hardangle(turretNearAutoRed));
