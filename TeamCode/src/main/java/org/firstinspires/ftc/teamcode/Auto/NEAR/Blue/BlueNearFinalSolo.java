...
//
//@Disabled
//@Autonomous(name = "BLUE Near Solo️ ", group = "BLUE")
//public class BlueNearFinalSolo extends LinearOpMode {
//
...
//                new KPathCommand2(follower, nearPath.GateIntake10),
//                new KPathCommand2(follower, nearPath.GateIntake1)
////                new KPathCommand2(follower, nearPath.GateIntake1)
//                        .alongWith(
//                        new ParallelCommandGroup(
//                                intakeBackAutoGate(intakess, shooterss, gatess),
//                                new WaitForSensorCommand(() -> (!robot.FfeederBeam.getState() || !robot.FintakeBeam.getState()), 3500, 25).andThen(
//                                        intakess.IntakeFCommands(intakesubsystem.INTAKEF.OFF)
//                                ),
...
//                //TODO ====================== GatePick 3 =========================
////                new InstantCommand(()->Constants.pathConstraints.setTimeoutConstraint(Global.timeOut)),
//                new KPathCommand2(follower, nearPath.GateIntake1, 0.75, "BLUE").alongWith(
//                        new ParallelCommandGroup(
//                                intakeBackAutoGate(intakess, shooterss, gatess),
//                                new WaitForSensorCommand(() -> (!robot.FfeederBeam.getState() || !robot.FintakeBeam.getState()), 3500, 25).andThen(
//                                        intakess.IntakeFCommands(intakesubsystem.INTAKEF.OFF)
